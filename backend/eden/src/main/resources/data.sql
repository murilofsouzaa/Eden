...
INSERT INTO product (title, description, image_url, modeling, weight, material, created_at, updated_at) VALUES
    ...
    ('Blue Oversized Hoodie', 'Moletom oversized azul marinho com toque macio e conforto térmico.',
    ...
    ('Lima Training Shorts', 'Shorts verde lima com tecido leve e elástico quadridirecional.',
     '/clothes/men/gymshark-green-shorts-masculine.jpeg', 'Regular', '180g/m²', '100% Poliéster', TIMESTAMP '2025-12-05 07:45:00', NULL),
    ('Black Long Tee', 'Camiseta longa de compressão com recortes ergonômicos e toque frio.',
    ...
    ('Onyx Compression Tee', 'Modelo manga longa com suporte muscular gradiente e acabamento fosco.',
    ...
    ('Carbon Compression Tee', 'Camiseta justa com painel respirável e proteção UV 50.',
    ...
    ('Elite Compression Top', 'Modelo elite com gola alongada, ajuste progressivo e detalhes refletivos.',
    ...
    ('Black Oversized Men', 'Camiseta oversized preta com barra alongada e tecido de algodão premium.',
     '/clothes/men/gymshark-black-oversized-masculine.jpeg', 'Oversized', '250g/m²', '100% Algodão', TIMESTAMP '2025-11-02 12:15:00', NULL),
    ('Pro Training Shorts', 'Short preto com painéis laterais perfurados e cordão embutido.',
    ...
    ('Green Oversized Tee', 'Camiseta oversized verde com malha de gramatura média.',
    ...
    ('Plum Seamless Tee', 'Camiseta seamless em tom ameixa com textura canelada e ventilação integrada.',
    ...
    ('White Joggers', 'Versão frontal dos joggers brancos destacando o ajuste cônico.',
    ...
    ('Black Sculpt Set', 'Conjunto seamless preto com top suporte médio e legging cintura alta.',
     '/clothes/women/gymshar-black-set-women.jpeg', 'Fitted', '220g/m²', '82% Nylon, 18% Elastano', TIMESTAMP '2025-09-05 09:50:00', NULL),
    ('Crimson Wine Pants', 'Visão traseira da calça vinho com recortes respiráveis e bolso interno.',
    ...
    ('Blue Ocean Legging', 'Legging azul oceano com acabamento gelado e recortes ondulados.',
     '/clothes/women/gymshark-blue-ocean-legging.jpeg', 'Fitted', '218g/m²', '89% Nylon, 11% Elastano', TIMESTAMP '2025-09-14 09:35:00', NULL),
    ('Grey Studio Set', 'Conjunto cinza com textura jacquard e ventilação estratégica.',
     '/clothes/women/gymshark-grey-set-women.jpeg', 'Fitted', '225g/m²', '84% Nylon, 16% Elastano', TIMESTAMP '2025-09-20 12:00:00', NULL),
    ('Red Wine Pants', 'Calça vinho com corte fluido e abertura lateral para mobilidade.',
    ...
    ('Brown Lounge Set', 'Conjunto marrom com malha acetinada e top de decote quadrado.',
    ...
    ('Shark Hoodie White', 'Moletom branco com capuz, toque macio e caimento confortável.',
    ...
    ('Vital Leggings Men', 'Legging masculina seamless com compressão leve e acabamento liso.',
    ...
    ('Gym Tops Men', 'Coleção de tops e camisetas masculinas com foco em performance.',
    ...
    ('Oxy Muscle Tee', 'Camiseta preta com visual musculação e tecido de alta elasticidade.',
    ...
    ('Sports Fitness Set', 'Imagem de lançamento com destaque para roupas esportivas e fitness.',
    ...
    ('Lifting Collection Men', 'Vista frontal de coleção de treino masculino com ajuste atlético.',
    ...
    ('Green Workout Set', 'Conjunto masculino verde para treino com visual monocromático.',
    ...
    ('Hyperflex Sky Tee', 'Camiseta cropped azul sky com modelagem leve para treino.',
    ...
    ('Hyperflex Shorts Gray', 'Shorts charcoal com tecido flexível e cintura anatômica.',
    ...
    ('Crop Tank Navy', 'Top cropped seamless azul-marinho com acabamento sem costura.',
    ...
    ('Crop Tank Black', 'Top cropped preto com caimento extra ajustado e visual moderno.',
    ...
    ('Pink Gym Sets', 'Coleção de conjuntos rosa para academia e treino funcional.',
    ...
    ('Black Blue Set', 'Conjunto seamless preto com detalhes azul-claros para treino.',
     '/clothes/women/30-04-26-black-light-blue.jpeg', 'Set', '230g/m²', '86% Nylon, 14% Elastano', TIMESTAMP '2026-04-30 10:40:00', NULL),
    ('White Training Shoes', 'Tênis branco feminino para treino com visual clean e leveza.',
    ...
    ('Vital Sleeve Top', 'Top de manga longa preto mescla com recortes e estilo atlético.',
    ...
    ('Gymshark Sports Top', 'Top esportivo feminino com suporte médio e tecido respirável.',
    ...
    ('Vuori Tank Navy', 'Regata Vuori com malha leve e respirável para alta performance.',
    ...
    ('Black White Set', 'Conjunto masculino preto e branco com visual clean e esportivo.',
...
INSERT INTO product (title, description, image_url, modeling, weight, material, created_at, updated_at) VALUES
    ('Vuori Navy KORE', 'Regata Vuori navy da coleção KORE com malha leve e respirável.',
    ...
    ('Vuori Grey KORE', 'Regata Vuori sky grey da coleção KORE com caimento atlético.',
    ...
    ('Vuori Tee Chambray', 'Camiseta muscle Vuori chambray da coleção KORE com tecido stretch-knit.',
    ...
    ('Vuori Shorts Ink', 'Shorts Vuori KORE sem forro com 5" e foco em mobilidade.',
    ...
    ('Vuori Legging Lake', 'Legging AllTheFeels KORE em tom Lake com cintura alta.',
    ...
    ('Vuori Kaia Styles', 'Seleção feminina KORE inspirada em looks de treino e lifestyle.',
    ...
    ('Vuori Blue Coast', 'Legging AllTheFeels KORE Blue Coast com toque macio e compressão leve.',
    ...
    ('Vuori Legging Midnight', 'Legging Clean Elevation KORE em Midnight Heather para treino e uso diário.',
...
SET discount_percentage = CASE 
    WHEN title IN ('Black Compression Tee', 'White Performance Joggers', 'Emerald Seamless Legging', 'Black Sculpt Set') THEN 10
    WHEN title IN ('Shark Hoodie Black', 'Shark Hoodie White', 'Conjunto Fitness Preto', 'Conjunto Fitness Rosa', 'Pink Gym Sets') THEN 20
    WHEN title IN ('Gymshark Sports Top', 'Crop Tank Navy', 'Crop Tank Black') THEN 25
...
JOIN product p ON (
    CASE t.name
        ...
        WHEN 'FEATURED' THEN p.title IN ('Black Compression Tee', 'Blue Oversized Hoodie', 'Shark Hoodie Black', 'Conjunto Fitness Preto')
        ELSE FALSE
    END
)
...
SET set_id = CASE 
    ...
    ELSE set_id
END
WHERE title IN ('Vuori Tank Navy', 'Black White Set')
...
INSERT INTO product_variant (product_id, sku, color, size, price, stock, category, gender, status, is_default) VALUES
    ((SELECT id FROM product WHERE title = 'Black Compression Tee'), 'SKU-0001', 'BLACK', 'M', 129.90, 35, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Black Compression Tee'), 'SKU-0001-L', 'BLACK', 'L', 129.90, 18, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', FALSE),
    ((SELECT id FROM product WHERE title = 'Blue Oversized Hoodie'), 'SKU-0002', 'NAVY', 'M', 229.90, 18, 'SWEATSHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Blue Oversized Hoodie'), 'SKU-0002-L', 'NAVY', 'L', 229.90, 10, 'SWEATSHIRTS', 'MASCULINE', 'AVAILABLE', FALSE),
    ((SELECT id FROM product WHERE title = 'White Performance Joggers'), 'SKU-0003', 'WHITE', 'M', 179.90, 22, 'PANTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Lima Training Shorts'), 'SKU-0004', 'LIME', 'M', 99.90, 40, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Black Long Tee'), 'SKU-0005', 'BLACK', 'M', 119.90, 27, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Onyx Compression Tee'), 'SKU-0006', 'ONYX', 'M', 129.90, 18, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Carbon Compression Tee'), 'SKU-0007', 'CARBON', 'M', 129.90, 31, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Elite Compression Top'), 'SKU-0008', 'BLACK', 'M', 139.90, 19, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Black Oversized Men'), 'SKU-0009', 'BLACK', 'M', 149.90, 25, 'SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Pro Training Shorts'), 'SKU-0010', 'BLACK', 'M', 99.90, 34, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Green Oversized Tee'), 'SKU-0011', 'GREEN', 'M', 149.90, 21, 'SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Plum Seamless Tee'), 'SKU-0012', 'PLUM', 'M', 129.90, 29, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Arctic Court Shorts'), 'SKU-0014', 'WHITE', 'M', 89.90, 26, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'White Joggers'), 'SKU-0015', 'WHITE', 'M', 179.90, 20, 'PANTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Emerald Seamless Legging'), 'SKU-0016', 'GREEN', 'S', 159.90, 28, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Cloudy Oversized Tee'), 'SKU-0017', 'WHITE', 'S', 129.90, 32, 'SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Black Sculpt Set'), 'SKU-0018', 'BLACK', 'S', 219.90, 24, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Crimson Wine Pants'), 'SKU-0019', 'CRIMSON', 'S', 169.90, 17, 'PANTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Midnight Sculpt Legging'), 'SKU-0020', 'BLACK', 'S', 159.90, 30, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Blue Ocean Legging'), 'SKU-0021', 'BLUE', 'S', 159.90, 27, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Grey Studio Set'), 'SKU-0022', 'GREY', 'S', 229.90, 23, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ...
    ((SELECT id FROM product WHERE title = 'Vital Leggings Men'), 'SKU-0030', 'BLACK', 'M', 149.90, 20, 'LEGGING', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Gym Tops Men'), 'SKU-0031', 'BLACK', 'M', 119.90, 24, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Oxy Muscle Tee'), 'SKU-0032', 'BLACK', 'M', 129.90, 29, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Sports Fitness Set'), 'SKU-0033', 'MULTI', 'U', 89.90, 12, 'SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Lifting Collection Men'), 'SKU-0034', 'BLACK', 'M', 119.90, 22, 'SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Green Workout Set'), 'SKU-0035', 'GREEN', 'M', 209.90, 18, 'SET', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Conjunto Fitness Preto'), 'SKU-0036', 'BLACK', 'S', 219.90, 31, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Conjunto Fitness Rosa'), 'SKU-0037', 'PINK', 'S', 219.90, 27, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Hyperflex Sky Tee'), 'SKU-0038', 'SKY_BLUE', 'S', 99.90, 33, 'SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Hyperflex Shorts Gray'), 'SKU-0039', 'CHARCOAL', 'S', 89.90, 35, 'SHORTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Crop Tank Navy'), 'SKU-0040', 'NAVY', 'S', 109.90, 30, 'T_SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Crop Tank Black'), 'SKU-0041', 'BLACK', 'S', 109.90, 28, 'T_SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Pink Gym Sets'), 'SKU-0042', 'PINK', 'S', 229.90, 25, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Black Blue Set'), 'SKU-0043', 'BLACK', 'S', 239.90, 21, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'White Training Shoes'), 'SKU-0044', 'WHITE', '37', 199.90, 19, 'SHOES', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vital Sleeve Top'), 'SKU-0045', 'BLACK MARL', 'S', 129.90, 23, 'SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Gymshark Sports Top'), 'SKU-0046', 'BLACK', 'S', 109.90, 34, 'T_SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Tank Navy'), 'SKU-0047', 'NAVY', 'M', 149.90, 26, 'REGATTA', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Black White Set'), 'SKU-0050', 'BLACK_WHITE', 'M', 199.90, 18, 'SET', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Navy KORE'), 'SKU-0051', 'NAVY', 'M', 149.90, 24, 'REGATTA', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Grey KORE'), 'SKU-0052', 'SKY_GREY', 'M', 149.90, 22, 'REGATTA', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Tee Chambray'), 'SKU-0053', 'CHAMBRAY', 'M', 139.90, 20, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Shorts Ink'), 'SKU-0054', 'INK', 'M', 159.90, 18, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Legging Lake'), 'SKU-0055', 'LAKE', 'M', 179.90, 19, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Kaia Styles'), 'SKU-0056', 'MULTI', 'M', 239.90, 14, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Blue Coast'), 'SKU-0057', 'BLUE_COAST', 'M', 179.90, 17, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
    ((SELECT id FROM product WHERE title = 'Vuori Legging Midnight'), 'SKU-0058', 'MIDNIGHT_HEATHER', 'M', 189.90, 16, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE);
...
INSERT INTO product_image (product_id, url, is_main) VALUES
    ((SELECT id FROM product WHERE title = 'Vuori Tank Navy'), '/clothes/men/01-05-26-(SET-vuori-set-blue-blackman)Built to perform in the heat, the Viewpoint Muscle Tank is made with our lightweight, stretch-knit mesh_ Shop this men''s Navy shirt from Vuori.jpeg', FALSE),
    ((SELECT id FROM product WHERE title = 'Vuori Tank Navy'), '/clothes/men/01-05-26-(SET-vuori-set-blue-blackman)Viewpoint-Muscle-Tank–-Navy–Vuori.jpeg', FALSE);
...
INSERT INTO shopping_cart_item (cart_id, variant_id, quantity, unit_price) VALUES
    ...
    ((SELECT id FROM shopping_cart WHERE user_id = (SELECT id FROM users WHERE email = 'diego.martins@eden.com')),
     (SELECT pv.id FROM product_variant pv JOIN product p ON p.id = pv.product_id WHERE p.title = 'White Joggers' AND pv.is_default = TRUE), 1, 179.90),
    ((SELECT id FROM shopping_cart WHERE user_id = (SELECT id FROM users WHERE email = 'marina.lopes@eden.com')),
     (SELECT pv.id FROM product_variant pv JOIN product p ON p.id = pv.product_id WHERE p.title = 'Emerald Seamless Legging' AND pv.is_default = TRUE), 1, 159.90);
