...
INSERT INTO product_variant (product_id, sku, color, size, price, stock, category, gender, status, is_default) VALUES
	...
	((SELECT id FROM product WHERE title = 'Black Long Compression Shirt'), 'SKU-0005', 'BLACK', 'M', 119.90, 27, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Onyx Compression Long Tee'), 'SKU-0006', 'ONYX', 'M', 129.90, 18, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Carbon Compression Performance Tee'), 'SKU-0007', 'CARBON', 'M', 129.90, 31, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Shadow Pro Training Shorts'), 'SKU-0010', 'BLACK', 'M', 99.90, 34, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Plum Seamless Performance Tee'), 'SKU-0012', 'PLUM', 'M', 129.90, 29, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Arctic Court Shorts'), 'SKU-0014', 'WHITE', 'M', 89.90, 26, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'White Performance Joggers Front View'), 'SKU-0015', 'WHITE', 'M', 179.90, 20, 'PANTS', 'MASCULINE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Black Sculpt Seamless Set'), 'SKU-0018', 'BLACK', 'S', 219.90, 24, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Crimson Wine Pants (Back)'), 'SKU-0019', 'CRIMSON', 'S', 169.90, 17, 'PANTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Midnight Sculpt Legging'), 'SKU-0020', 'BLACK', 'S', 159.90, 30, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Blue Ocean Motion Legging'), 'SKU-0021', 'BLUE', 'S', 159.90, 27, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Grey Studio Seamless Set'), 'SKU-0022', 'GREY', 'S', 229.90, 23, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Red Wine Performance Pants'), 'SKU-0023', 'RED', 'S', 169.90, 19, 'PANTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Brown Lounge Seamless Set'), 'SKU-0024', 'BROWN', 'S', 229.90, 21, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Black Oversized City Tee'), 'SKU-0025', 'BLACK', 'S', 129.90, 28, 'SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Prada Hydrate Bottle'), 'SKU-0026', 'STEEL', 'ONE', 59.90, 55, 'WATER_BOTTLE', 'UNISSEX', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Gym King Energy Linear Vest Black'), 'SKU-0027', 'BLACK', 'M', 99.90, 26, 'REGATTA', 'MASCULINE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Vital Collection Seamless Leggings Men'), 'SKU-0030', 'BLACK', 'M', 149.90, 20, 'LEGGING', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Mens Gym Tops and T Shirts Collection'), 'SKU-0031', 'BLACK', 'M', 119.90, 24, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Gymshark Sports Fitness Releases'), 'SKU-0033', 'MULTI', 'U', 89.90, 12, 'SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Lifting Collection For Men Front View'), 'SKU-0034', 'BLACK', 'M', 119.90, 22, 'SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'All Green Workout Outfits For Men'), 'SKU-0035', 'GREEN', 'M', 209.90, 18, 'SET', 'MASCULINE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Hyperflex 2 Cropped Tee Sky Blue'), 'SKU-0038', 'SKY_BLUE', 'S', 99.90, 33, 'SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Hyperflex 2 Shorts Charcoal'), 'SKU-0039', 'CHARCOAL', 'S', 89.90, 35, 'SHORTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Gymshark Everyday Seamless Crop Tank Navy'), 'SKU-0040', 'NAVY', 'S', 109.90, 30, 'T_SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Gymshark Fraction Crop Tank Black'), 'SKU-0041', 'BLACK', 'S', 109.90, 28, 'T_SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Pink Gym Sets and Workout Sets'), 'SKU-0042', 'PINK', 'S', 229.90, 25, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Black Light Blue Seamless Set'), 'SKU-0043', 'BLACK', 'S', 239.90, 21, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'White Training Shoes Feminine'), 'SKU-0044', 'WHITE', '37', 199.90, 19, 'SHOES', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vital Long Sleeve Cut Out Top Black Marl'), 'SKU-0045', 'BLACK MARL', 'S', 129.90, 23, 'SHIRTS', 'FEMININE', 'AVAILABLE', TRUE),
	...
	((SELECT id FROM product WHERE title = 'Vuori Viewpoint Muscle Tank Navy KORE'), 'SKU-0051', 'NAVY', 'M', 149.90, 24, 'REGATTA', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori Viewpoint Muscle Tank Sky Grey KORE'), 'SKU-0052', 'SKY_GREY', 'M', 149.90, 22, 'REGATTA', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori Strato Muscle Tee Chambray KORE'), 'SKU-0053', 'CHAMBRAY', 'M', 139.90, 20, 'T_SHIRTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori Course Shorts Unlined 5 Ink KORE'), 'SKU-0054', 'INK', 'M', 159.90, 18, 'SHORTS', 'MASCULINE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori AllTheFeels Legging Lake KORE'), 'SKU-0055', 'LAKE', 'M', 179.90, 19, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori Favorite Styles by Kaia Gerber KORE'), 'SKU-0056', 'MULTI', 'M', 239.90, 14, 'SET', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori AllTheFeels Legging Blue Coast KORE'), 'SKU-0057', 'BLUE_COAST', 'M', 179.90, 17, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE),
	((SELECT id FROM product WHERE title = 'Vuori Clean Elevation Legging Midnight Heather KORE'), 'SKU-0058', 'MIDNIGHT_HEATHER', 'M', 189.90, 16, 'LEGGING', 'FEMININE', 'AVAILABLE', TRUE);
...
INSERT INTO shopping_cart_item (cart_id, variant_id, quantity, unit_price) VALUES
	...
	((SELECT id FROM shopping_cart WHERE user_id = (SELECT id FROM users WHERE email = 'diego.martins@eden.com')),
	 (SELECT pv.id FROM product_variant pv JOIN product p ON p.id = pv.product_id WHERE p.title = 'White Performance Joggers' AND pv.is_default = TRUE), 1, 179.90),
