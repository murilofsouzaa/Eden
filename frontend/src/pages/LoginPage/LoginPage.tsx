            ...
            <div className="flex flex-col justify-center items-center">   
                ...
                <form className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <p className="text-sm text-black/80">Não possui conta? <span className="font-bold text-sm text-black hover:cursor-pointer hover:underline">Criar Conta</span></p>
                    </div>
                </form>
            </div>
        </div>
